...
//! 2. `sys_dma_alloc`      — allocate physically contiguous RX/TX descriptor
//!    rings.
...
pub extern "C" fn _start() -> ! {
    unsafe {
        ...
        //    sys_driver_bind.  For QEMU virtio-mmio the canonical base is 0xa000_0000;
        //    adjust if your QEMU args differ.
