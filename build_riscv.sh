...
#
# Boot modes:
#   UEFI (default) — EDK2 RiscVVirt, target riscv64-uefi.json, output .efi
#   SBI  (--sbi)   — OpenSBI/QEMU -kernel, target riscv64gc-unknown-none-elf
#
# Usage:
#   ./build_riscv.sh                 # UEFI release build (default)
#   ./build_riscv.sh --debug         # UEFI debug build
#   ./build_riscv.sh --sbi           # SBI release build
#   ./build_riscv.sh --sbi --debug   # SBI debug build
