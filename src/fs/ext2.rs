...
impl Ext2Fs {
    ...
    // ── block pointer read (for block-map inodes) ─────────────────────────────
    ...
    // ── read all data bytes of an inode ──────────────────────────────────────
    ...
    // ── write data back into block-map inode (extend or truncate) ─────────────
    //
    // Strategy:
    ...
    // ── flatten block pointers for an inode ───────────────────────────────────
    ...
    // ── flush dirty blocks to block device ────────────────────────────────────
...
// ── VFS read/write helpers used by vfs_ops via fcntl ─────────────────────────
//
