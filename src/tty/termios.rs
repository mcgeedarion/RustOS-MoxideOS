...
impl Termios {
    ...
    pub fn cooked_default() -> Self {
        ...
        Termios {
            ...
            c_lflag:  lflag::ISIG | lflag::ICANON | lflag::ECHO
                    | lflag::ECHOE | lflag::ECHOK | lflag::ECHOCTL | lflag::ECHOKE
                    | lflag::IEXTEN,
            c_line:   0,
            c_cc:     cc,
            c_ispeed: 38400,
    ...
    pub fn raw_default() -> Self {
        ...
        t.c_iflag &= !(iflag::IGNBRK | iflag::BRKINT | iflag::PARMRK
    ...
    pub fn is_canonical(&self) -> bool { self.c_lflag & lflag::ICANON != 0 }
    pub fn is_echo(&self)      -> bool { self.c_lflag & lflag::ECHO   != 0 }
    pub fn is_isig(&self)      -> bool { self.c_lflag & lflag::ISIG   != 0 }
    pub fn is_opost(&self)     -> bool { self.c_oflag & oflag::OPOST  != 0 }
    pub fn is_onlcr(&self)     -> bool { self.c_oflag & oflag::ONLCR  != 0 }
