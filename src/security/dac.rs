...
//!      New:  (file_permitted | (file_inheritable & self.inheritable)) &
//! self.permitted      The old formula allowed any file-inheritable capability
//! to bypass      the task's own inheritable mask, enabling privilege
//! escalation via      a crafted binary with file capabilities.
//!
