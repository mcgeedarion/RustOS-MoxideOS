...
//!
//! ## Sv39 address layout
//!   Virtual address: [38:30] VPN[2] | [29:21] VPN[1] | [20:12] VPN[0] | [11:0]
//! offset   SATP: MODE(4 bits) | ASID(16 bits) | PPN(44 bits) — MODE 8 = Sv39
//!
...
/// Map a 4 KiB page into the page table whose root physical address is
/// `root_pa`. `flags` should include desired PTE_R/W/X/U bits; PTE_V is always
/// OR-ed in.
