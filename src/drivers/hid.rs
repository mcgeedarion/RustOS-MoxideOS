...
const HID_TO_KEY: [u16; 128] = {
    ...
    let mut i = 0u16;
    while i < 26 {
        t[(0x04 + i) as usize] = KeyCode::KEY_A as u16 + i;
        i += 1;
    }
    // 1-9, 0
    t[0x1E] = KeyCode::KEY_1 as u16;
    t[0x1F] = KeyCode::KEY_2 as u16;
    t[0x20] = KeyCode::KEY_3 as u16;
    t[0x21] = KeyCode::KEY_4 as u16;
    t[0x22] = KeyCode::KEY_5 as u16;
    t[0x23] = KeyCode::KEY_6 as u16;
    t[0x24] = KeyCode::KEY_7 as u16;
    t[0x25] = KeyCode::KEY_8 as u16;
    t[0x26] = KeyCode::KEY_9 as u16;
    t[0x27] = KeyCode::KEY_0 as u16;
    // Misc
    ...
    t[0x3A] = KeyCode::KEY_F1 as u16;
    t[0x3B] = KeyCode::KEY_F2 as u16;
    t[0x3C] = KeyCode::KEY_F3 as u16;
    t[0x3D] = KeyCode::KEY_F4 as u16;
    t[0x3E] = KeyCode::KEY_F5 as u16;
    t[0x3F] = KeyCode::KEY_F6 as u16;
    t[0x40] = KeyCode::KEY_F7 as u16;
    t[0x41] = KeyCode::KEY_F8 as u16;
    t[0x42] = KeyCode::KEY_F9 as u16;
    t[0x43] = KeyCode::KEY_F10 as u16;
    t[0x44] = KeyCode::KEY_F11 as u16;
    t[0x45] = KeyCode::KEY_F12 as u16;
...
fn hid_usage_to_key(usage: u8) -> u16 {
    if (usage as usize) < HID_TO_KEY.len() {
...
pub fn hid_mouse_report(report: &[u8]) {
    ...
    if dx != 0 {
        push_rel(RelCode::REL_X as u16, dx as i32);
    }
    if dy != 0 {
        push_rel(RelCode::REL_Y as u16, dy as i32);
    }
    if dw != 0 {
        push_rel(RelCode::REL_WHEEL as u16, dw as i32);
    }
