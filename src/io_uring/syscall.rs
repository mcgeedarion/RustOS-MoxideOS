...
pub fn sys_io_uring_register(fd: usize, opcode: u32, arg_va: usize, nr_args: u32) -> isize {
    ...
    match opcode {
        IORING_REGISTER_BUFFERS => {
            ...
            if copy_from_user(arg_va, &mut buf).is_err() {
                return -14;
            }
            ring::with_ring_mut(ring_idx, |r| {
                r.reg_bufs.clear();
        ...
        IORING_REGISTER_FILES => {
            ...
            if copy_from_user(arg_va, bytes).is_err() {
                return -14;
            }
            ring::with_ring_mut(ring_idx, |r| {
                r.reg_fds = fds.clone();
        ...
        IORING_REGISTER_EVENTFD => {
            ...
            if copy_from_user(arg_va, &mut efd_bytes).is_err() {
                return -14;
            }
        ...
        IORING_REGISTER_FILES_UPDATE => {
            ...
            if copy_from_user(arg_va, &mut raw).is_err() {
                return -14;
            }
