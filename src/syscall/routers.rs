...
pub fn dispatch_filesystem(ctx: &SyscallContext) -> Option<isize> {
    ...
    match ctx.nr {
        ...
        SYS_FCHOWNAT   => Some(0), // ownership not enforced
        SYS_FUTIMESAT  => Some(crate::syscall::sys_futimesat_impl(a as i32, b, c)),
        SYS_NEWFSTATAT => Some(crate::syscall::sys_newfstatat_impl(a as i32, b, c, d as u32)),
        ...
        SYS_LINKAT     => Some(crate::syscall::sys_linkat_impl(a as i32, b, c as i32, d, e as i32)),
        ...
        SYS_FCHMODAT   => Some(0), // permissions not enforced
        SYS_FACCESSAT  => Some(crate::fs::stat_syscalls::sys_faccessat(a as i32, b, c as u32)),
        ...
        SYS_COPY_FILE_RANGE => Some(crate::syscall::sys_copy_file_range_impl(a, b, c, d, e, f as u32)),
        ...
        SYS_STATX      => Some(crate::syscall::sys_statx_impl(a as i32, b, c as u32, d as u32, e)),
        SYS_CLOSE_RANGE => {
            match (super::arg_u32(a), super::arg_u32(b), super::arg_u32(c)) {
        ...
        SYS_SENDTO      => Some(crate::net::socket::sys_sendto(a, b, c, d as i32, e, f as u32)),
        ...
        SYS_SOCKETPAIR  => Some(crate::net::socket::sys_socketpair(a as i32, b as i32, c as i32, d)),
        SYS_SETSOCKOPT  => Some(crate::net::socket::sys_setsockopt(a, b as i32, c as i32, d, e as u32)),
        SYS_GETSOCKOPT  => Some(crate::net::socket::sys_getsockopt(a, b as i32, c as i32, d, e)),
        SYS_ACCEPT4 => {
...
pub fn dispatch_process(ctx: &SyscallContext) -> Option<isize> {
    ...
    match ctx.nr {
        ...
        SYS_EXIT        => { crate::proc::exit::sys_exit(a as i32); Some(0) }
        SYS_EXIT_GROUP  => { crate::proc::exit::sys_exit_group(a as i32); Some(0) }
        ...
        SYS_WAITID => {
            match (super::arg_i32(a), super::arg_i32(b), super::arg_u32(d)) {
        ...
        SYS_RT_SIGPROCMASK => {
            match super::arg_u32(a) {
                Some(how) if how <= 2 =>
                    Some(crate::proc::signal::sys_rt_sigprocmask(how, b, c, d)),
                _ => Some(einval()),
            }
        }
        ...
        SYS_SCHED_YIELD     => { crate::proc::scheduler::yield_cpu(); Some(0) }
        ...
        SYS_SETRESUID => Some(crate::syscall::sys_setresuid_impl(a as u32, b as u32, c as u32)),
        SYS_GETPGRP   => Some(crate::syscall::sys_getpgrp_impl()),
        SYS_SETPGID   => {
            match (super::arg_u32(a), super::arg_u32(b)) {
        ...
        SYS_SCHED_GETATTR => Some(crate::syscall::sys_sched_getattr_impl(a, b as u32, c as u32, d as u32)),
        ...
        SYS_REBOOT        => Some(crate::syscall::sys_reboot_impl(a as u32, b as u32, c as u32, d)),
...
pub fn dispatch_memory(ctx: &SyscallContext) -> Option<isize> {
    ...
    match ctx.nr {
        ...
        SYS_PKEY_MPROTECT => Some(crate::syscall::sys_pkey_mprotect_impl(a, b, c as u32, d as i32)),
...
pub fn dispatch_time(ctx: &SyscallContext) -> Option<isize> {
    ...
    match ctx.nr {
        ...
        SYS_TIMER_SETTIME    => Some(crate::syscall::sys_timer_settime_impl(a as u32, b as i32, c, d)),
