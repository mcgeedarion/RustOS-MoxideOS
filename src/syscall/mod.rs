...
//!   NR   9  MAP_FIXED_NOREPLACE (0x100000)     => mm::mmap::sys_mmap (now returns -EEXIST)
//!   NR  89  readlink("/proc/self/exe", …)      => stat_syscalls (routes to procfs_readlink)
//!   NR 267  readlinkat — same routing fix
...
pub fn dispatch(nr: usize, a: usize, b: usize, c: usize,
    ...
    match nr {
        ...
        89  => crate::fs::stat_syscalls::sys_readlink(a, b, c),
        162 => sys_sync_impl(),
        ...
        267 => crate::fs::stat_syscalls::sys_readlinkat(a as i32, b, c, d),
        ...
        334 => crate::fs::close_range::sys_close_range(a as u32, b as u32, c as u32),
        // ── inotify ───────────────────────────────────────────────────────
