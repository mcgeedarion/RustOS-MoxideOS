...
#[inline(always)]
pub const fn enoent()   -> isize { -(ENOENT   as isize) }
#[inline(always)]
pub const fn esrch()    -> isize { -(ESRCH    as isize) }
#[inline(always)]
pub const fn eio()      -> isize { -(EIO      as isize) }
#[inline(always)]
pub const fn eacces()   -> isize { -(EACCES   as isize) }
#[inline(always)]
